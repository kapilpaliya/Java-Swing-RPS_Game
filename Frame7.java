...
public class Frame7 extends JFrame implements ActionListener{
    ...
    Container c;    JButton rock,scissor,replay,exit;      JLabel label1,label2,label3;    Font font1,font2;
    ...
    Frame7(){
        ...
        ImageIcon img1= new ImageIcon(Objects.requireNonNull(this.getClass().getResource("image\\I_Rock.png")));
